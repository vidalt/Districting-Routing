...
def parse_arguments():
    ...
    parser.add_argument('-depot_position', type=str)
    parser.add_argument('-instance_size', type=int)
    parser.add_argument('-target_size_district', type=int)
