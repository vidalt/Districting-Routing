...
public:
	...
	map<int, double> averageCustomersTrain;			 	
	map<int, double> averageCustomersTest;					
	

	map<int,vector<vector<Point>>> trainScenarios;				// Scenarios for each target size of distrcit - used to train 
	map<int,vector<vector<Point>>> testScenarios;				// Scenarios for each target size of distrcit - used to evaluate algorithm
